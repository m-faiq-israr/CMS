  ...
  return (
    <div className="font-poppins text-gray-700 dark:text-gray-100 pt-1 pb-4 ">
      <div className=" flex justify-between items-center">
        <h1 className="font-bold md:text-lg">{designation}</h1>
        <h1 className=" italic pt-2 text-sm md:text-base">{`(${startDate} - ${endDate})`}</h1>
      </div>

      <div>
        <h1 className="italic font-semibold text-gray-600 dark:text-gray-200 text-sm md:text-base">
          {companyName}
        </h1>
      </div>
