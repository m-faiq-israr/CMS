...
function LeftNav() {
  const { setShowSlide, showSlide, handleQuery } = useStateContext();
  return (
    // top section
    <div
      className={
        !showSlide
          ? "h-screen bg-gray-900 w-[300px] pt-4 hidden lg:flex items-center justify-between p-2 text-white flex-col translate-x-0 rounded-r-3xl"
          : "hidden"
      }
    >
